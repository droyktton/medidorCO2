...
[tabla](https://droyktton.github.io/loscoihues/ventilacion/CO2ACHProbInfeccionV3.html) según actividad). Entonces el número de cambios de aire por hora es ACH=2.35 aproximadamente. Medio: Podemos verificar que ese valor de ACH es consistente con los ppm de CO2. Derecha: conocido el ACH, y asumuiendo razonablemente que éste no cambia cambiando el número de personas adentro, podemos estimar la concentración que habría si hay diez personas en vez de tres, obteniendo el valor de 1401 ppm de CO2. Muchos más detalles y ejemplos ilustrativos de este tipo de cálculos en aulas pueden encontrarse 
[aquí](https://www.csic.es/sites/www.csic.es/files/guia_para_ventilacion_en_aulas_csic-mesura.pdf).
