...
*Es importante insistir en que *cualquier* exceso de CO2 con respecto del exterior es peligroso si hay incidencia (por ejemplo, en [Bariloche](https://droyktton.github.io/loscoihues/datos_crudos/parteoficialbche.html)) y la exposición es muy prolongada.* 
...
Muchos más detalles y ejemplos ilustrativos de este tipo de cálculos y otros análisis interesantes en **aulas de enseñanza** pueden encontrarse por ejemplo [aquí](http://www.jorgealiaga.com.ar/wp-content/uploads/2021/02/Estudio-Ventilacion-IES-Aldonza-Lorenzo-1.pdf) o [aquí](https://www.csic.es/sites/www.csic.es/files/guia_para_ventilacion_en_aulas_csic-mesura.pdf). Un resumen de recomendaciones prácticas para aulas puede encontrarse [aquí](https://droyktton.github.io/loscoihues/ventilacion/guia_para_ventilar_la_escuela.pdf). Recomendaciones prácticas sobre la ventilación en edificios fueron [recientemente publicadas](https://espanol.cdc.gov/coronavirus/2019-ncov/community/ventilation.html) por la CDC de Estados Unidos.    
...
*Es importante insistir en que la exhalación de CO2, y la de los aerosoles que la acompañan, cambia **mucho** con la actividad realizada. Por ejemplo, estando parados y quietos emitimos del orden de 10 veces menos CO2 que realizando una actividad deportiva. Por lo tanto, será necesaria una ventilación mucho mayor si la actividad es vigorosa.* 
...
+ Monitor Público: El código [gaugeserial.py](https://github.com/droyktton/medidorCO2/blob/main/medidoresIB/src/gaugeserial.py) se conecta via USB al medidor y provee una interface para mostrar gráficamente, en un monitor (idealmente grande) o en una pantalla de un proyector, un indicador de riesgo que esté a la vista de todos los ocupantes de una sala (comercio, aula, oficina, etc) todo el tiempo. La siguiente es una película acelerada de una medición real (saturando de CO2 con un soplido al sensor y dejando luego relajar), ilustrando lo que muestra la version más actual del código: 
...
![final](medidoresIB/doc/5medidores.jpg)
