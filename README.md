...
*Es importante insistir en que la exhalación de CO2, y la de los aerosoles que la acompañan, cambia **mucho** con la actividad realizada. Por ejemplo, estando parados y quietos emitimos del orden de 10 veces menos CO2 que realizando una actividad vigorosa (danza, gimnasia, deportes, etc). Por lo tanto, será necesaria una ventilación mucho mayor si la actividad es vigorosa (ver [tabla](https://droyktton.github.io/loscoihues/ventilacion/CO2ACHProbInfeccionV3.html) de emisiones según actividad)* 
