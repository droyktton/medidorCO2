...
Aunque existen [modelos teóricos](https://www.edx.org/es/course/physics-of-covid-19-transmission), es muy difícil hacer estimaciones precisas directamente de la probabilidad de contagio, debido a la gran incertidumbre de algunos paramétros necesarios para hacer las [predicciones cuantitativas](https://www.medrxiv.org/content/10.1101/2020.08.26.20182824v2.full). Una recomendación simplista pero muy práctica es mantener la concentración  de CO2 en un interior a valores < 800 ppm, que implica que el ~1% del aire que respiramos ya fue respirado (más precisamente es el exceso respecto del valor exterior de ~400 ppm el que determina ese 1%). Se asume, en esta recomendación, que se mantiene una distancia interpersonal que reduce el riesgo de contagio por transmisión de corto alcance, y que la ocupación es compartida por una duración estandard de algunas horas, la típica de clases o de trabajo de oficina, ya que la dosis total bajo exposición al virus es igual al producto de su concentración por el tiempo. Así, *cualquier exceso de CO2 con respecto del exterior es peligroso si la exposición es muy prolongada*. 
...
9. Otros accesorios: 
   ...
   2. Cables Dupont Macho Hembra y Macho Macho de 20cm **40**. 
